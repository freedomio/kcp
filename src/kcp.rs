...
mod tests {
    ...
    extern "C" {
        static mut vnet: Latency_simulator;
    }
    ...
    unsafe fn test(mode: isize) {
        vnet = Latency_simulator::new(10, 60, 125, 1000);
        let mut kcp1: KCP = KCP::new(0x11223344, udp_output1);
        let mut kcp2: KCP = KCP::new(0x11223344, udp_output2);
